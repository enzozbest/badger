...
urlpatterns = [
    ...
    path('tutor/calendar/<int:pk>', calendar_view.TutorCalendarView.as_view(), name='tutor_calendar'),
    path('student/calendar/<int:pk>', calendar_view.StudentCalendarView.as_view(),name='student_calendar'),
    ...
    #path('admins/calendar/', calendar_view.AdminCalendarView.as_view(), name='admin_calendar'),
    path('admins/calendar/cancel/', cancel_lessons_view.CancelLessonsView.as_view(),name='admin_cancel_lessons'),
