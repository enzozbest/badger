...
from invoicer.views import generate_invoice_id
...
class TestGenerateInvoice(TestCase):
    ...
    def test_generate_invoice_id(self):
        self.assertEqual(generate_invoice_id(self.student), str(self.invoice.invoice_id))
    ...
    def test_generate_invoice_local_store(self):
        ...
        path = f'{settings.INVOICE_OUTPUT_PATH}/{generate_invoice_id(self.student)}.pdf'
    ...
    def test_generate_invoice(self):
        ...
        invoice_generator.generate_invoice(self.request)
        path = f'invoices/pdfs/{generate_invoice_id(self.student)}.pdf'
